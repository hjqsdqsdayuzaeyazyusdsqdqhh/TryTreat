                ...
                <div class="offer-preview-card">
                  <div class="offer-preview-top">
                    <div class="offer-preview-top-badges">
                      <span class="offer-preview-badge offer-preview-badge--dark">Germany</span>
                      <span class="offer-preview-badge offer-preview-badge--accent">Verified Offer</span>
                    </div>
                    <div class="offer-preview-top-icon" aria-hidden="true">
                      <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="6" y="12" width="36" height="28" rx="6" fill="white" fill-opacity="0.15"/>
                        <rect x="6" y="12" width="36" height="8" rx="6" fill="white" fill-opacity="0.1"/>
                        <circle cx="14" cy="28" r="4" fill="white" fill-opacity="0.2"/>
                        <circle cx="14" cy="28" r="2" fill="white" fill-opacity="0.4"/>
                        <rect x="24" y="26" width="12" height="3" rx="1.5" fill="white" fill-opacity="0.2"/>
                        <rect x="24" y="32" width="9" height="3" rx="1.5" fill="white" fill-opacity="0.15"/>
                        <rect x="24" y="38" width="14" height="2" rx="1" fill="white" fill-opacity="0.12"/>
                        <path d="M36 8L38 12L42 14L38 16L36 20L34 16L30 14L34 12Z" fill="#22c55e" fill-opacity="0.3"/>
                      </svg>
                    </div>
                  </div>
                  <div class="offer-preview-main">
                    <div class="offer-preview-reward-badge" aria-hidden="true">
                  ...
                  <div class="offer-preview-info">
                    <div class="offer-preview-info-title">How it works</div>
                    <ul class="offer-preview-info-list">
                      <li>Open the offer</li>
                      <li>Check eligibility</li>
                      <li>Complete registration</li>
                      <li>Follow partner instructions</li>
                    </ul>
                  </div>
                  <div class="offer-preview-notice">
                    <div class="offer-preview-notice-icon">i</div>
                    <div class="offer-preview-notice-content">
                      <strong>Important</strong><br>
                      Availability may change at any time. Always review the partner page for the latest terms and eligibility requirements.
                    </div>
                  </div>
